"""
Django settings for royal_tooth_4 project.
...
ROOT_URLCONF = 'royal_tooth_4.urls'
...
WSGI_APPLICATION = 'royal_tooth_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_tooth_4 API",
    "DESCRIPTION": "API documentation for royal_tooth_4 App",
    "VERSION": "v1",
}
